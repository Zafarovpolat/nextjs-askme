...
export const mockQuestions: Question[] = [
  ...
  {
    id: 10,
    title: 'Как правильно ухаживать за кактусами в зимний период?',
    content: 'Интересует полив и температурный режим.',
    slug: 'kak-ukhazhivat-za-kaktusami-zimoy',
    author: mockUsers[13],
    category: mockCategories[2],
    rating: 10,
    status: 'opened',
  ...
  },
  {
    ...
    content: 'Краткое научное объяснение.',
    slug: 'pochemu-nebo-goluboe',
    author: mockUsers[13],
    category: mockCategories[3],
    rating: 15,
    status: 'closed',
  ...
  {
    id: 12,
    title: 'Лучшие книги по саморазвитию 2024 года',
    content: 'Посоветуйте что-нибудь стоящее.',
    slug: 'knigi-po-samorazvitiyu-2024',
    author: mockUsers[13],
    category: mockCategories[4],
    rating: 25,
    status: 'voting',
