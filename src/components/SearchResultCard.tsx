...
export default function SearchResultCard({
  ...
  // Если это профиль премиум пользователя, все его вопросы получают премиум стили
  // Иначе только вопросы с флагом isPremium
  const isPremium =
    userIsPremium || (!isOwnProfile && (question as any).isPremium === true);
