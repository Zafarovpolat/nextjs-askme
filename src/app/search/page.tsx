...
function SearchPageContent() {
  ...
  const question = filteredQuestions[0] ?? mockQuestions[0];
    ...
    >
      ...
      <div className="main_question_block_actions">
        <div className="main_question_block_actions_left">
          ...
          <button
            className="s_btn s_btn_icon btn_thumb_up"
            title="Мне нравится"
          >
          ...
          <p>
            <span className="likes_count">{answer.rating}</span>
            <span className="likes_word"> нравится</span>
          </p>
        </div>
            ...
            <div className="question_leaders">
              ...
              {mockUsers.slice(0, 5).map((user) => (
                <Link href={`/profile/${user.username}`} key={user.id}>
                  <div
                    className={`question_list_item ${user.vipStatus ? "premium-question" : ""}`}
                  >
                    <div className="question_list_item_left">
                      <div
                        style={{
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <select className="super-select super-select--no-bg">
            ...
            <div style={{ marginTop: "35px", paddingBottom: "0px" }}>
              <div className="search-results-header">
                <h2 className="search-results-count">
                  {numWord(filteredQuestions.length, [
                    "совпадение",
                    "совпадения",
                    "совпадений",
                  ])}
                ...
                >
                  <button
                    type="button"
                    className="search-sort-btn active"
                    style={{
                      background: "none",
                      border: "none",
                      cursor: "pointer",
            ...
            {rightSidebarQuestions.map((q) => {
              ...
              return (
                <Link href={`/question/${q.id}`} key={q.id}>
                  <div
                    className={`question_list_item question_leader_card ${isPremium ? "premium-question" : ""}`}
