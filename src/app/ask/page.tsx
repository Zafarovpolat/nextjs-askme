...
const categories = [
  ...
  },
  {
    slug: "sport",
    name: "Спорт",
    subcategories: ["Теннис", "Футбол", "Хоккей", "Зимние виды спорта"],
  },
  {
    slug: "homework",
    name: "Домашние задания",
    subcategories: ["Математика", "Алгебра", "Геометрия", "Иностранные языки"],
  },
  {
    slug: "programming",
    name: "Программирование",
    subcategories: ["Android", "C/C++", "Python", "Веб-дизайн"],
  },
];
...
export default function AskPage() {
  ...
  const getFilteredQuestions = () => {
    switch (activeTab) {
      case 0:
        return similarQuestions.filter((q) => q.status === "opened");
      case 1:
        return similarQuestions.filter((q) => q.status === "voting");
      case 2:
        return similarQuestions.filter((q) => q.status === "closed");
      case 3:
        return similarQuestions;
      case 4:
        return similarQuestions.filter((q) => (q as any).isPremium === true);
      default:
        return similarQuestions;
    }
  };
          ...
          <form className="ask_form form" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="asf_form_actions">
              ...
              <div className="ask_form_checkboxes">
                ...
                <button type="button" className="ask_premium_btn">
                  <svg
                    width="25"
                    height="25"
                    viewBox="0 0 25 25"
                    ...
                    className="premium_checkbox_icon"
                  >
                    <rect width="25" height="25" rx="6" fill="white" />
                    <path
                      d="M11.9812 17.8865C11.8534 18.0279 11.6325 18.0387 11.4902 17.9104L6.11092 13.0623C5.96862 12.934 5.96243 12.7183 6.09702 12.5828L7.81087 10.8583C7.94554 10.7227 8.17213 10.7169 8.31443 10.845L11.2529 13.4932C11.3952 13.6214 11.6162 13.6107 11.7439 13.4693L17.4846 7.11754C17.6124 6.97614 17.8385 6.96 17.9869 7.08173L19.8766 8.6305C20.0251 8.75216 20.042 8.96747 19.9142 9.10886L11.9812 17.8865Z"
                      fill="#626AFF"
                    />
                  </svg>
                  <svg
